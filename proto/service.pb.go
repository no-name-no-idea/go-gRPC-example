...
var file_service_proto_rawDesc = []byte{
	...
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33, 0x22, 0x25, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x6c, 0x74, 0x32, 0x65, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x28, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2d, 0x0a, 0x08, 0x4d, 0x75,
	0x6c, 0x74, 0x69, 0x70, 0x6c, 0x79, 0x12, 0x0f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*Response)(nil), // 1: proto3.Response
}
var file_service_proto_depIdxs = []int32{
	0, // 0: proto3.AddService.Add:input_type -> proto3.Request
	0, // 1: proto3.AddService.Multiply:input_type -> proto3.Request
	1, // 2: proto3.AddService.Add:output_type -> proto3.Response
	1, // 3: proto3.AddService.Multiply:output_type -> proto3.Response
...
func (c *addServiceClient) Add(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto3.AddService/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *addServiceClient) Multiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto3.AddService/Multiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AddService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto3.AddService/Add",
	}
...
func _AddService_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto3.AddService/Multiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
